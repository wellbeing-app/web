...
export default async function Home({ params } : { params: Promise<{ lang: string }> }) {
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center p-4 md:p-8 overflow-hidden pt-32">
      <div className="glass relative z-10 w-full max-w-[40rem] flex flex-col items-center justify-center animate-in fade-in theme-transition p-10 md:p-16 rounded-4xl text-center space-y-8">
