      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 -translate-x-1/2 w-[95%] max-w-200 z-50 md:hidden bg-card rounded-3xl p-6 border border-border/50 flex flex-col items-center gap-3 top-safe-menu"
          >
            {children}
          </motion.div>
        </>
